...
their attention and move on when it doesn't. A system that always probes is
less realistic, and it's exhausting to sit through.
...
target. If the evidence is there after 0 follow-ups, it moves on. A system
