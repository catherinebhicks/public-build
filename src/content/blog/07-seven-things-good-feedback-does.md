...
dimensions the agent's output is held to. 6 of the 7 can block a
release on their own.

| Dimension | Focus |
|---|---|
| **Grounding** | Every critique must be supported by what the candidate actually said. |
| **Actionability** | Feedback must contain concrete, usable next steps rather than generic advice. |
...
session, and it's the one that matters most. If someone runs 5 sessions
