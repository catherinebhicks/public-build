...
This ends up as three separate things the system keeps:
...
The difference matters. "You paused for eleven seconds before answering" is
an observation. "You seemed nervous" is a diagnosis, and the product has no
business making it.

## Why keep delivery at all
...
The satisfying version is one number. The honest version is three lines that
sometimes disagree.
...
lesson — that the fix is performance.
