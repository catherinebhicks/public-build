...
- **Six to eight seconds** of silence before any gentle check-in. Long enough
  to think; short enough not to feel abandoned.
- **One prompt**, not repeated nagging.
- **Ninety seconds** and no answer started — move on.
- **Two minutes** if they're mid-answer and working through it.
...
You should be able to see where you are in a thirty-minute interview — that's
real pressure worth rehearsing. But a countdown ticking down inside a single
...
useful version of that information — *you gave yourself two minutes on the
last question* — delivered when you can do something with it rather than
