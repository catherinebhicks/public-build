...
And then, more specifically — an Indian English option, because in tech
hiring that's frequently who you'll be talking to.

The feature is straightforward: a small curated set of interviewer voices
varying by gender presentation and English accent. Four to start. A name, a
...
anything's wrong with either of you — because comprehension takes a little
...
tenth time is easier than the first. The practice environment is exactly where
...
V1, but architected so other languages can be added. Better to ship one
language honestly than to half-support several.
