...
The order matters. The rubric is the thing the model is *held to*, written
before there is anything to explain rather than afterwards to justify it.
...
said, is the mechanism that stops it.
